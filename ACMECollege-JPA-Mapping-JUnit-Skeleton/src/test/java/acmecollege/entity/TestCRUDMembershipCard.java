...
public class TestCRUDMembershipCard extends JUnitBase {
	...
	static void setupAllInit() {
		student = new Student();
		student.setFullName("Emma", "Watson");
		// Initialize other fields of student as required
		
		DurationAndStatus ds = new DurationAndStatus();
		ds.setDurationAndStatus(LocalDateTime.of(2023, 8, 28, 0, 0), LocalDateTime.of(2024, 8, 27, 0, 0) , "+");

		
		clubNonAcademic = new NonAcademicStudentClub();
		clubNonAcademic.setName("Student Move Club");
...
//		assertEquals(result, 1);
	...
	void test06_Update() {
	    ...
	    newStudent.setFullName("Miok",  "Kim");
